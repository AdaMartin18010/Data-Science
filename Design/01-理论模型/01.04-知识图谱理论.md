...
- [知识图谱理论：关系知识图与图查询](#知识图谱理论关系知识图与图查询)
  ...
  - [3. 关系知识图](#3-关系知识图)
    ...
    - [3.3. 知识图谱到关系数据库的映射](#33-知识图谱到关系数据库的映射)
      - [3.3.1. 知识图谱到关系数据库转换决策树](#331-知识图谱到关系数据库转换决策树)
      - [3.3.2. 转换算法的完整实现](#332-转换算法的完整实现)
      - [3.3.3. 转换正确性证明](#333-转换正确性证明)
      - [3.3.4. 转换示例](#334-转换示例)
      - [3.3.5. 知识图谱到关系数据库映射对比矩阵](#335-知识图谱到关系数据库映射对比矩阵)
  - [4. 图查询语言](#4-图查询语言)
...
- **Chain-of-Knowledge：将知识推理融入大型语言模型**：2024年6月，张一飞等人提出了"Chain-of-Knowledge"框架，旨在通过学习知识图谱，将知识推理能力整合到大型语言模型中。该框架包括数据集构建和模型学习两部分，旨在提升模型的知识推理能力（arXiv:2407.00653，2024）
- **KnowFormer：重新审视用于知识图谱推理的Transformer模型**：2024年9月，刘俊楠等人提出了"KnowFormer"方法，利用Transformer架构从信息传递的角度进行知识图谱推理。该方法引入了结构感知模块，以增强自注意力机制中的结构信息，提升了模型在推理任务中的表现（arXiv:2409.12865，2024）

**知识图谱应用**：

- **面向新质生产力的知识图谱关键技术与应用**：2024年10月，中国计算机学会在CNCC2024大会上举办了以"面向新质生产力，知识图谱关键技术与应用"为主题的论坛。论坛探讨了大语言模型与知识图谱的融合，以及知识图谱在新型社会生产关系和制度体系中的应用（CCF，2024）
- **课程知识图谱助力哲学社会科学自主知识体系构建**：2025年4月，中国社会科学网报道了课程知识图谱在哲学社会科学自主知识体系构建中的应用，强调了知识图谱在教育领域的重要性（中国社会科学网，2025）
- **2025年度新闻传播学知识图谱**：2025年11月，中国传媒大学出版社推出了"2025年度新闻传播学知识图谱"系列课程，邀请多位权威学者系统梳理新闻传播学研究的最新成果，构建专业知识框架（中国传媒大学出版社，2025）
