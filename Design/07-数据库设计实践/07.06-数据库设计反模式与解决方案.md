...
- [数据库设计反模式与解决方案：常见陷阱与最佳实践](#数据库设计反模式与解决方案常见陷阱与最佳实践)
  ...
  - [11. 形式化反模式识别](#11-形式化反模式识别)
    - [11.1. 反模式形式化定义](#111-反模式形式化定义)
...
| 资源 | URL | 描述 |
|------|-----|------|
| **PostgreSQL Wiki** | <https://wiki.postgresql.org/wiki/Don%27t_Do_This> | PG反模式 |
| **Use The Index, Luke** | <https://use-the-index-luke.com> | 索引反模式 |
| **SQL Performance** | <https://sqlperformance.com> | 性能反模式 |

### 12.3. 相关文档

- [07.01-Schema设计方法论](./07.01-Schema设计方法论.md)
- [07.08-数据库性能调优](./07.08-数据库性能调优.md)
