...
- [../01-理论模型/01.11-最新共识算法理论.md](../01-理论模型/01.11-最新共识算法理论.md)
- [../05-项目集成/05.01-PostgreSQL扩展-分布式数据库.md](../05-项目集成/05.01-PostgreSQL扩展-分布式数据库.md)

### 9.2. 最新权威资源（2024-2025）

**市场规模与增长预测**：

- **中国分布式事务数据库市场**：2024年中国分布式事务数据库市场规模达到1.5亿美元，同比增长18.5%（IDC，2024）
- **未来增长预测**：IDC预测，到2029年，该市场规模将达到19.0亿美元，2024-2029年的年复合增长率（CAGR）为19.4%（IDC，2024）

**部署模式变化**：

- **本地部署市场**：2024年上半年，本地部署分布式事务数据库软件市场规模为1.4亿美元，同比增长16.7%，占比38.8%（IDC，2024）
- **公有云市场**：2024年上半年，公有云市场规模2.2亿美元，同比增长19.7%，占比61.2%（IDC，2024）
- **未来趋势**：预计从2025年开始，本地部署市场的增速将超过公有云市场，2024-2029年的年复合增长率将达到22.8%（IDC，2024）

**主要厂商表现**：

- **OceanBase**：在本地部署市场以21.2%的市场份额位居第一，首次登顶本地部署整体市场榜首；在金融行业以23.9%的市场份额连续两年位列本地部署第一（新浪财经，2025）
- **腾讯云数据库TDSQL**：在金融行业分布式事务型数据库市场中，以21.32%的市场份额位居榜首，并在银行子市场以22.48%的占有率继续位居第一，连续两年实现"双料冠军"（新浪财经，2025）

**技术创新与标准化**：

- **星环科技**：6款数据库产品入选《中国数据库产业图谱（2024年）》，涵盖分布式数据库、时序数据库、时空数据库、图数据库、搜索型数据库和多模数据库等类别（星环科技社区，2024）
- **运维管理标准**：中国通信标准化协会大数据技术标准推进委员会（CCSA TC601）发布了《分布式数据库运维管理实践指南（1.0）》，为行业提供了权威的运维管理指导（CCSA TC601，2024）
