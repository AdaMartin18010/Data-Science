...
- [数据建模指导：从业务需求到数据库设计的实践指南](#数据建模指导从业务需求到数据库设计的实践指南)
  ...
  - [8. 2024-2025建模趋势](#8-2024-2025建模趋势)
    - [8.1. 数据建模方法演进](#81-数据建模方法演进)
    - [8.2. 建模方法选型矩阵](#82-建模方法选型矩阵)
    - [8.3. AI辅助数据建模](#83-ai辅助数据建模)
    - [8.4. 多模态数据建模](#84-多模态数据建模)
  - [9. 参考资料](#9-参考资料)
    - [9.1. 权威文献](#91-权威文献)
    - [9.2. 在线资源](#92-在线资源)
    - [9.3. 相关文档](#93-相关文档)
...
| 方法 | 适用场景 | 复杂度 | 灵活性 | 学习曲线 |
|------|---------|--------|--------|---------|
| **ER建模** | OLTP系统 | 中 | 中 | 低 |
| **维度建模** | 数据仓库 | 中 | 低 | 中 |
| **Data Vault** | 企业数据湖 | 高 | 高 | 高 |
| **图建模** | 关系网络 | 中 | 高 | 中 |
| **文档建模** | 内容管理 | 低 | 高 | 低 |
...
| **Vertabelo** | <https://vertabelo.com/> | 协作建模 |

### 9.3. 相关文档

- [07.01-Schema设计方法论](./07.01-Schema设计方法论.md)
- [07.02-元模型理论](./07.02-元模型理论.md)
- [01-理论模型/01.02-关系数据库理论](../01-理论模型/01.02-关系数据库理论.md)
