...
- [2.3.1 Petri网理论基础](#231-petri网理论基础)
  - [📑 目录](#-目录)
  - [1. 摘要](#1-摘要)
  - [3. Petri网概述](#3-petri网概述)
    - [3.1. Petri网的定义](#31-petri网的定义)
    - [3.2. Petri网的特点](#32-petri网的特点)
  - [4. 基本Petri网](#4-基本petri网)
    - [4.1. Petri网的形式化定义](#41-petri网的形式化定义)
    - [4.2. 变迁的使能条件](#42-变迁的使能条件)
    - [4.3. 变迁的触发](#43-变迁的触发)
    - [4.4. 可达性](#44-可达性)
  - [5. 高级Petri网](#5-高级petri网)
    - [5.1. 时间Petri网](#51-时间petri网)
  - [6. 着色Petri网](#6-着色petri网)
  - [7. 层次Petri网](#7-层次petri网)
  - [8. 并发语义](#8-并发语义)
    - [8.1. 步语义](#81-步语义)
    - [8.2. 部分序语义](#82-部分序语义)
    - [8.3. 进程语义](#83-进程语义)
  ...
  - [11. 应用领域](#11-应用领域)
    - [11.1. 并发系统](#111-并发系统)
    - [11.2. 工作流系统](#112-工作流系统)
    - [11.3. 制造系统](#113-制造系统)
  - [12. 本地跳转与交叉引用](#12-本地跳转与交叉引用)
  - [13. 多表征](#13-多表征)
  - [14. 形式化语义](#14-形式化语义)
...
- [Petri网理论分支导航](./README.md) - Petri网理论完整知识体系
...
- [Petri网理论深化](../../8-形式理论深化/8.3-Petri网理论深化/README.md) - Petri网理论深化内容
...
- [工作流域深化](../../9-软件工程深化/9.4-工作流域深化/README.md) - 工作流域深化
- [形式化方法](../../../Design/01-理论模型/01.05-形式化方法.md) - 形式化方法理论

### 12.2. 最新权威资源（2024-2025）

- **形式化方法专刊** - 《软件学报》2025年第8期"形式化方法与应用"专刊，涵盖形式化方法的基础理论、技术和工具
- **《系统掌握形式化方法：从理论到实践的完整教材》** - 2025年10月发布，培养逻辑推理与软件验证能力
- [Petri网理论资源](https://en.wikipedia.org/wiki/Petri_net)
