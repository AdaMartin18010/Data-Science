...
- [2.4.1 时态逻辑控制理论基础](#241-时态逻辑控制理论基础)
  ...
  - [1. 摘要](#1-摘要)
  - [3. 时态逻辑概述](#3-时态逻辑概述)
    - [3.1. 时态逻辑的定义](#31-时态逻辑的定义)
    - [3.2. 时态逻辑的分类](#32-时态逻辑的分类)
  - [4. 线性时态逻辑](#4-线性时态逻辑)
    - [4.1. LTL语法](#41-ltl语法)
    - [4.2. LTL语义](#42-ltl语义)
    - [4.3. LTL示例](#43-ltl示例)
  - [5. 分支时态逻辑](#5-分支时态逻辑)
    - [5.1. CTL语法](#51-ctl语法)
    - [5.2. CTL语义](#52-ctl语义)
    - [5.3. CTL与LTL的关系](#53-ctl与ltl的关系)
  - [6. 时态控制理论](#6-时态控制理论)
    - [6.1. 控制系统模型](#61-控制系统模型)
    - [6.2. 控制器设计](#62-控制器设计)
    - [6.3. 监督控制](#63-监督控制)
  - [7. 模型检查](#7-模型检查)
    - [7.1. 模型检查算法](#71-模型检查算法)
    - [7.2. Büchi自动机](#72-büchi自动机)
...
- [时态逻辑控制理论分支导航](./README.md) - 时态逻辑控制理论完整知识体系
...
- [时态逻辑控制理论深化](../../8-形式理论深化/8.4-时态逻辑控制理论深化/README.md) - 时态逻辑控制理论深化
- [数据科学基础理论](../../3-数据模型与算法/3.1-基础理论/3.1.1-数据科学基础理论框架.md) - 数据科学基础理论
- [并发控制算法](../../3-数据模型与算法/3.3-算法实现/3.3.3-并发控制算法.md) - 并发控制算法
- [软件架构基础理论](../../4-软件架构与工程/4.1-基础理论/4.1.1-软件架构基础理论.md) - 软件架构基础理论
- [形式化方法](../../../Design/01-理论模型/01.05-形式化方法.md) - 形式化方法理论

### 9.2. 最新权威资源（2024-2025）

- **形式化方法专刊** - 《软件学报》2025年第8期"形式化方法与应用"专刊，涵盖模型检查等时态逻辑应用
- **形式化方法公开课** - 中国计算机学会形式化方法专业委员会（CCF TCFM）举办，主题包括定理证明、约束求解等
- **形式化数学推理的崛起** - Meta FAIR和斯坦福大学等机构2024年12月联合发布论文，探讨形式化数学推理在AI未来发展中的关键作用
- [时态逻辑资源](https://en.wikipedia.org/wiki/Temporal_logic)
- [模型检查工具](https://en.wikipedia.org/wiki/Model_checking)
