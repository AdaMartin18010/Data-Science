...
- [类型理论分支导航](./README.md) - 类型理论完整知识体系
- [形式科学理论知识导航索引](../README.md) - 形式科学理论知识导航
- [编程语言理论](../2.8-编程语言理论/README.md) - 编程语言理论基础
- [数学基础理论](../2.7-数学基础理论/README.md) - 类型理论的数学基础
- [类型理论深化](../../8-形式理论深化/8.1-类型理论深化/README.md) - 类型理论深化内容
...
### 15.3. 最新权威资源（2024-2025）

- **《系统掌握形式化方法：从理论到实践的完整教材》** - 2025年10月发布，涵盖布尔代数、谓词逻辑、Z表示法、B方法、模型检验等内容
- **形式化方法专刊** - 《软件学报》2025年第8期"形式化方法与应用"专刊，收录12篇论文
- **形式化数学推理的崛起** - Meta FAIR和斯坦福大学等机构2024年12月联合发布论文
