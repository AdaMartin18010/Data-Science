...
- [2.5.1 分布式系统理论基础](#251-分布式系统理论基础)
  ...
  - [5. 一致性理论](#5-一致性理论)
    - [5.1. CAP定理](#51-cap定理)
    - [5.2. 一致性模型](#52-一致性模型)
    - [5.3. FLP不可能性定理](#53-flp不可能性定理)
  - [6. 容错理论](#6-容错理论)
    - [6.1. 故障模型](#61-故障模型)
    - [6.2. 复制技术](#62-复制技术)
    - [6.3. 故障检测](#63-故障检测)
  - [7. 分布式事务](#7-分布式事务)
    - [7.1. 两阶段提交 (2PC)](#71-两阶段提交-2pc)
    - [7.2. 三阶段提交 (3PC)](#72-三阶段提交-3pc)
...
- [分布式系统理论分支导航](./README.md) - 分布式系统理论完整知识体系
- [形式科学理论知识导航索引](../README.md) - 形式科学理论知识导航
- [类型理论](../2.1-类型理论/README.md) - 类型理论基础
- [自动机理论](../2.2-自动机理论/README.md) - 自动机理论基础
...
- [数据科学基础理论](../../3-数据模型与算法/3.1-基础理论/3.1.1-数据科学基础理论框架.md) - 数据科学基础理论
- [数据模型形式化理论](../../3-数据模型与算法/3.2-形式化模型/3.2.1-数据模型的形式化理论.md) - 数据模型形式化理论
...
- [Matter分布式系统理论](../../../Matter/Theory/Distributed_Systems_Theory.md) - Matter分布式系统理论

### 9.2. 最新权威资源（2024-2025）

- **最新共识算法理论** - 2024-2025年最新研究成果，包括Raft、Paxos等算法的改进和优化
- **ForeSight：预测调度的确定性数据库** - 2024年研究，通过轻量级冲突预测和知情调度提高事务提交率和并发性
- **FCDB（函子范畴数据库）** - 2024年研究，提出信息保留和反交换性减少的组合框架
- [分布式系统资源](https://en.wikipedia.org/wiki/Distributed_computing)
