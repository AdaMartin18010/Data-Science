...
- [1.4.9 NewSQL实践案例](#149-newsql实践案例)
  - [📑 目录](#-目录)
  - [1. 概述](#1-概述)
  - [2. 目录](#2-目录)
  - [3. TiDB实践案例](#3-tidb实践案例)
    - [3.1. TiDB集群配置](#31-tidb集群配置)
  - [4. TiDB数据模型设计](#4-tidb数据模型设计)
    - [4.1. TiDB事务处理](#41-tidb事务处理)
  - [5. CockroachDB实践案例](#5-cockroachdb实践案例)
    - [5.1. CockroachDB多区域配置](#51-cockroachdb多区域配置)
    - [5.2. CockroachDB事务处理](#52-cockroachdb事务处理)
  - [6. 分布式事务实践案例](#6-分布式事务实践案例)
    - [6.1. 两阶段提交实现](#61-两阶段提交实现)
  - [7. 性能优化实践案例](#7-性能优化实践案例)
    - [7.1. 读写分离配置](#71-读写分离配置)
  - [8. 连接池和缓存优化](#8-连接池和缓存优化)
  - [9. 总结](#9-总结)
...
- [性能调优与监控](./1.4.6-性能调优与监控.md) - NewSQL性能优化
- [安全与合规](./1.4.7-安全与合规.md) - NewSQL安全合规
