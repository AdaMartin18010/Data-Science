...
- [多模型数据库理论](../../../Design/01-理论模型/01.03-多模型数据库理论.md) - 多模型数据库理论基础
...
### 11.3. 最新权威资源（2024-2025）

- **《数据库系统原理与设计（第4版）》** - 吴京慧等著，2024年2月出版，涵盖最新技术和实践
- **《数据库系统概念（第7版）》** - Abraham Silberschatz等著，提供数据库系统全面概述
- **最新共识算法理论** - 2024-2025年最新研究成果，包括Raft、Paxos等算法的改进和优化
- [NewSQL数据库资源](https://en.wikipedia.org/wiki/NewSQL)
- [分布式数据库理论](https://en.wikipedia.org/wiki/Distributed_database)
