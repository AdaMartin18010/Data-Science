...
- [1.1.145 PostgreSQL 2025 Features — Deployment Guide and Operations](#11145-postgresql-2025-features-deployment-guide-and-operations)
  - [📑 目录](#-目录)
- [1. Overview](#1-overview)
- [2. Readiness Checklist](#2-readiness-checklist)
- [3. Enabling Key Features](#3-enabling-key-features)
  - [3.1. AI-native Functions](#31-ai-native-functions)
  - [3.2. Vector Indexes (HNSW/IVF)](#32-vector-indexes-(hnswivf))
  - [3.3. Streaming Windows & CEP](#33-streaming-windows-cep)
  - [3.4. Multimodal Storage](#34-multimodal-storage)
- [4. Production Rollout Strategy](#4-production-rollout-strategy)
- [5. SLOs and Alerts (Templates)](#5-slos-and-alerts-(templates))
- [6. Operations Playbook](#6-operations-playbook)
- [7. Security and Compliance](#7-security-and-compliance)
- [8. Rollback and Recovery (Go/No-Go)](#8-rollback-and-recovery-(gono-go))
