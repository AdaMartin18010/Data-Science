...
- [知识图谱机器学习集成](#知识图谱机器学习集成)
  - [📑 目录](#-目录)
- [1. 图神经网络 (GNN)](#1-图神经网络-(gnn))
  - [1.1. GNN基础框架](#11-gnn基础框架)
- [2. 知识图谱嵌入](#2-知识图谱嵌入)
  - [2.1. 知识图谱嵌入模型](#21-知识图谱嵌入模型)
- [3. 推荐系统](#3-推荐系统)
  - [3.1. 基于知识图谱的推荐系统](#31-基于知识图谱的推荐系统)
- [4. 异常检测](#4-异常检测)
  - [4.1. 基于图神经网络的异常检测](#41-基于图神经网络的异常检测)
- [5. 工具与平台](#5-工具与平台)
  - [5.1. 机器学习框架](#51-机器学习框架)
  - [5.2. 知识图谱工具](#52-知识图谱工具)
  - [5.3. 推荐系统工具](#53-推荐系统工具)
  - [5.4. 异常检测工具](#54-异常检测工具)
- [6. 最佳实践](#6-最佳实践)
  - [6.1. 模型选择](#61-模型选择)
  - [6.2. 训练策略](#62-训练策略)
  - [6.3. 评估指标](#63-评估指标)
