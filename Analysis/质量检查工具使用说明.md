...
- [5. 命令行参数](#5-命令行参数)
  - [5.1. 使用示例](#51-使用示例)
    - [5.1.1. 检查单个文档](#511-检查单个文档)
- [6. 检查整个模块](#6-检查整个模块)
- [7. 检查整个知识库](#7-检查整个知识库)
- [8. 输出格式](#8-输出格式)
  - [8.1. HTML报告](#81-html报告)
  - [8.2. JSON报告](#82-json报告)
- [9. 问题类型与严重程度](#9-问题类型与严重程度)
  - [9.1. 问题类型](#91-问题类型)
  - [9.2. 严重程度](#92-严重程度)
- [10. 评分标准](#10-评分标准)
  - [10.1. 标题层次评分](#101-标题层次评分)
  - [10.2. 代码质量评分](#102-代码质量评分)
  - [10.3. 数学公式评分](#103-数学公式评分)
  - [10.4. 链接有效性评分](#104-链接有效性评分)
  - [10.5. 格式规范性评分](#105-格式规范性评分)
- [11. 最佳实践](#11-最佳实践)
  - [11.1. 文档结构最佳实践](#111-文档结构最佳实践)
  - [11.2. 代码示例最佳实践](#112-代码示例最佳实践)
  - [11.3. 数学公式最佳实践](#113-数学公式最佳实践)
  - [11.4. 链接管理最佳实践](#114-链接管理最佳实践)
- [12. 持续改进](#12-持续改进)
  - [12.1. 定期检查](#121-定期检查)
- [13. 问题跟踪](#13-问题跟踪)
  - [13.1. 质量提升](#131-质量提升)
- [14. 故障排除](#14-故障排除)
  - [14.1. 常见问题](#141-常见问题)
    - [14.1.1. 文件编码问题](#1411-文件编码问题)
- [15. 依赖问题](#15-依赖问题)
- [16. 权限问题](#16-权限问题)
- [17. 调试模式](#17-调试模式)
- [18. 扩展功能](#18-扩展功能)
  - [18.1. 自定义检查规则](#181-自定义检查规则)
- [19. 集成到CI/CD](#19-集成到cicd)
---
