...
- [基础理论分支导航](../README.md) - 数据模型与算法基础理论导航
- [数据模型与算法知识导航索引](../../README.md) - 数据模型与算法知识导航
- [形式化模型](../3.2-形式化模型/README.md) - 数据模型形式化理论
- [算法实现](../3.3-算法实现/README.md) - 核心算法实现
- [AI与机器学习算法](../3.4-AI与机器学习算法/README.md) - AI与机器学习算法
- [数据分析与ETL](../3.5-数据分析与ETL/README.md) - 数据分析与ETL实践
- [数据科学基础理论](../../数据模型理论体系/1-基础理论/1.1-数据理论基础/README.md) - 数据理论基础
- [数据建模理论](../../数据模型理论体系/1-基础理论/1.2-数据建模理论/README.md) - 数据建模理论
- [数据质量理论](../../数据模型理论体系/1-基础理论/1.3-数据质量理论/README.md) - 数据质量理论

### 相关资源

- [数据科学最佳实践](https://www.kaggle.com/learn)
- [机器学习资源](https://scikit-learn.org/)
- [数据可视化工具](https://matplotlib.org/)

### 最新权威资源（2024-2025）

- **《机器学习方法（第2版）》** - 李航著，2024年12月出版，全面升级，涵盖强化学习等最新内容
- **分布自适应学习框架（DAL）** - Chao Xu等，2024年11月，应对数据流分布随时间演变的挑战
- **理论指导的数据科学（TGDS）范式** - 强调将科学知识融入数据科学模型，提高科学一致性和可解释性
- **《深度学习与机器学习——Python数据结构与数学基础：从理论到实践》** - Silin Chen等著，2024年10月出版
