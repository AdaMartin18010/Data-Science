...
- [3.4.5 深度学习架构](#345-深度学习架构)
  - [1. 概述](#1-概述)
  - [2. 目录](#2-目录)
  - [3. 神经网络基础理论](#3-神经网络基础理论)
    - [3.1. 神经元模型](#31-神经元模型)
    - [3.2. 万能逼近定理](#32-万能逼近定理)
    - [3.3. 深度的重要性](#33-深度的重要性)
  - [4. 前馈神经网络](#4-前馈神经网络)
    - [4.1. 多层感知机（MLP）](#41-多层感知机mlp)
    - [4.2. 反向传播算法](#42-反向传播算法)
  - [5. 卷积神经网络](#5-卷积神经网络)
    - [5.1. 卷积运算](#51-卷积运算)
    - [5.2. 经典CNN架构](#52-经典cnn架构)
    - [5.3. 注意力机制](#53-注意力机制)
  - [6. 循环神经网络](#6-循环神经网络)
    - [6.1. 标准RNN](#61-标准rnn)
    - [6.2. LSTM架构](#62-lstm架构)
    - [6.3. GRU简化设计](#63-gru简化设计)
  - [7. Transformer架构](#7-transformer架构)
    - [7.1. 自注意力机制](#71-自注意力机制)
    - [7.2. 多头注意力](#72-多头注意力)
    - [7.3. 位置编码](#73-位置编码)
    - [7.4. Transformer块结构](#74-transformer块结构)
  - [8. 生成模型](#8-生成模型)
    - [8.1. 变分自编码器（VAE）](#81-变分自编码器vae)
    - [8.2. 生成对抗网络（GAN）](#82-生成对抗网络gan)
    - [8.3. 扩散模型](#83-扩散模型)
  - [9. 优化理论与技术](#9-优化理论与技术)
    - [9.1. 梯度下降变体](#91-梯度下降变体)
    - [9.2. 学习率调度](#92-学习率调度)
    - [9.3. 批归一化](#93-批归一化)
  - [10. 正则化与泛化理论](#10-正则化与泛化理论)
  ...
  - [11. 表示学习理论](#11-表示学习理论)
    - [11.1. 特征学习](#111-特征学习)
    - [11.2. 流形假设](#112-流形假设)
    - [11.3. 信息瓶颈原理](#113-信息瓶颈原理)
  - [12. Rust实现示例](#12-rust实现示例)
    - [12.1. 基础数据结构](#121-基础数据结构)
  - [13. 神经网络层](#13-神经网络层)
  - [14. 多层感知机](#14-多层感知机)
    - [14.1. 卷积层实现](#141-卷积层实现)
  - [15. 训练循环](#15-训练循环)
  - [16. 本地跳转链接](#16-本地跳转链接)
  - [17. 参考文献](#17-参考文献)
  - [18. 多表征](#18-多表征)
