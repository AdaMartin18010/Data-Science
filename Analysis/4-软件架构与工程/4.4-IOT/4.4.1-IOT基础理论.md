...
- [IOT基础理论](#iot基础理论)
  - [1. 目录](#1-目录)
  - [2. 物联网理论基础](#2-物联网理论基础)
    - [2.1. 物联网定义与核心概念](#21-物联网定义与核心概念)
    - [2.2. 物联网体系架构](#22-物联网体系架构)
    - [2.3. 物联网技术栈](#23-物联网技术栈)
  - [3. OTA更新机制](#3-ota更新机制)
    - [3.1. OTA更新理论](#31-ota更新理论)
    - [3.2. OTA系统组件](#32-ota系统组件)
    - [3.3. OTA设计原则](#33-ota设计原则)
    - [3.4. OTA架构模式](#34-ota架构模式)
  - [4. 物联网安全与协议](#4-物联网安全与协议)
    - [4.1. 安全威胁与防护](#41-安全威胁与防护)
    - [4.2. 通信协议](#42-通信协议)
    - [4.3. 身份认证与授权](#43-身份认证与授权)
  - [5. 边缘计算与智能终端](#5-边缘计算与智能终端)
    - [5.1. 边缘计算架构](#51-边缘计算架构)
    - [5.2. 智能终端设计](#52-智能终端设计)
    - [5.3. 本地处理与云端协同](#53-本地处理与云端协同)
  - [6. 物联网应用场景](#6-物联网应用场景)
    - [6.1. 智能家居](#61-智能家居)
    - [6.2. 工业物联网](#62-工业物联网)
    - [6.3. 智慧城市](#63-智慧城市)
