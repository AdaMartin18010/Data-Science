...
- [金融数据分析分支导航](./README.md) - 金融数据分析完整知识体系
- [行业应用与场景知识导航索引](../README.md) - 行业应用与场景知识导航
- [金融数据科学基础理论](5.1.1-金融数据科学基础理论.md) - 金融数据科学基础理论
- [数据科学基础理论](../../3-数据模型与算法/3.1-基础理论/3.1.1-数据科学基础理论框架.md) - 数据科学基础理论
- [机器学习基础理论](../../3-数据模型与算法/3.4-AI与机器学习算法/3.4.1-机器学习基础理论.md) - 机器学习基础理论
- [数据库系统](../../1-数据库系统/README.md) - 数据库系统架构

### 8.2. 最新权威资源（2024-2025）

- **大型语言模型（LLM）在金融预测与交易中的应用** - 2024年10月，将非结构化金融信息转化为有依据的信号和可执行决策
- **多代理系统在量化交易中的应用** - 2025年5月，数据中心的多代理框架，自动化量化策略的研发过程
- **强化学习在量化交易决策中的应用** - 2025年8月，结合多维技术指标和强化学习的智能交易代理
- **金融大模型的开发与应用** - 2025年，Fin-R1模型以7B参数量级实现高性能，覆盖金融计算、代码编写、智能风控等核心场景
- **量化交易策略的创新** - 2025年，基于拥挤交易理论的行业轮动策略
- [金融数据科学资源](https://en.wikipedia.org/wiki/Financial_data_analysis)
- [量化交易资源](https://en.wikipedia.org/wiki/Algorithmic_trading)
