...
- [科学计算分支导航](./README.md) - 科学计算完整知识体系
- [行业应用与场景知识导航索引](../README.md) - 行业应用与场景知识导航
- [数据科学基础理论](../../3-数据模型与算法/3.1-基础理论/3.1.1-数据科学基础理论框架.md) - 数据科学基础理论
- [核心数据处理算法](../../3-数据模型与算法/3.3-算法实现/3.3.1-核心数据处理算法.md) - 核心数据处理算法
- [分布式系统理论](../../2-形式科学理论/2.5-分布式系统理论/README.md) - 分布式系统理论基础
- [数据分析与ETL](../../3-数据模型与算法/3.5-数据分析与ETL/README.md) - 数据分析与ETL

### 6.2. 最新权威资源（2024-2025）

- **2025年中国高性能计算机（HPC）性能TOP100榜单** - 2025年，榜首系统测试性能达487.94 PFLOPS，系统峰值为620 PFLOPS
- **2025 CCF高性能计算专委算力生态战略研讨会** - 2025年12月，以"构建高性能计算软件生态，引领四极领域科研创新"为核心主题
- **DeepSeek-V3大型语言模型** - 2024年12月，专门适用于数学、编码和中文等任务，性能对标GPT-4o
- **高性能计算应用领域分布** - 2025年，算力服务占比达71%，超算中心占12%，科学计算占4.8%
- **Numerical Recipes: The Art of Scientific Computing** - 科学计算经典教材
- **High Performance Computing: Modern Systems and Practices** - 高性能计算现代系统与实践
- [科学计算资源](https://en.wikipedia.org/wiki/Scientific_computing)
- [高性能计算资源](https://en.wikipedia.org/wiki/High-performance_computing)
