...
- [关系建模分支导航](./README.md) - 关系建模完整知识体系
- [知识图谱与可视化知识导航索引](../README.md) - 知识图谱与可视化完整知识体系
- [知识表示基础理论](../6.1-知识表示/6.1.1-知识表示基础理论.md) - 知识表示基础理论
- [可视化技术基础理论](../6.3-可视化技术/6.3.1-可视化技术基础理论.md) - 可视化技术基础理论
...
- **GraphOracle：知识图谱推理的基础模型** - 2025年5月，通过将知识图谱转换为关系依赖图（RDG），统一跨知识图谱的推理过程
- **通用超边扩展：超关系知识图谱建模（TransEQ）** - 2024年11月，用于超关系知识图谱的建模方法
- **知识图谱与多模态学习的融合** - 2024年2月，综述探讨知识图谱与多模态学习的结合
- **大模型背景下知识图谱的理性回归** - 2024年2月，知识图谱在垂直领域的复杂问题问答推理中的作用
- **大模型时代的知识图谱年度进展报告** - 2025年1月，大模型与知识图谱协同发展的显著成果
- [关系建模资源](https://en.wikipedia.org/wiki/Entity%E2%80%93relationship_model)
