...
- [知识图谱与可视化知识导航索引](../README.md) - 知识图谱与可视化完整知识体系
- [知识表示分支导航](./README.md) - 知识表示完整知识体系
- [关系建模](../6.2-关系建模/README.md) - 关系建模理论
- [可视化技术](../6.3-可视化技术/README.md) - 可视化技术
- [数据科学基础理论](../../3-数据模型与算法/3.1-基础理论/3.1.1-数据科学基础理论框架.md) - 数据科学基础理论
- [数据模型形式化理论](../../3-数据模型与算法/3.2-形式化模型/3.2.1-数据模型的形式化理论.md) - 数据模型形式化理论
- [知识图谱理论](../../../Design/01-理论模型/01.04-知识图谱理论.md) - 知识图谱理论基础

### 21.2. 最新权威资源（2024-2025）

- **知识图谱与大模型的融合** - 2024年9月，全国知识图谱与语义计算大会（CCKS-IJCKG 2024）主题，探讨知识图谱与大模型的融合
- **知识图谱嵌入方法的创新（TransU模型）** - 2025年4月，处理具有密集定义本体的知识图谱嵌入问题
- **多模态学习与知识图谱的结合** - 2024年2月，《Knowledge Graphs Meet Multi-Modal Learning: A Comprehensive Survey》综述论文
- **知识图谱行业应用深化** - 2024年，可口可乐日本装瓶公司采用AI知识图谱平台优化供应链管理
- **全国知识图谱与语义计算大会（CCKS 2025）** - 2025年9月，福州举办，推动学术交流与合作
- [知识图谱资源](https://en.wikipedia.org/wiki/Knowledge_graph)
- [本体论资源](https://en.wikipedia.org/wiki/Ontology_(information_science))
