...
- [知识图谱构建技术深化](#知识图谱构建技术深化)
  - [1. 目录](#1-目录)
  - [2. 知识抽取技术](#2-知识抽取技术)
    - [2.1. 实体识别 (Named Entity Recognition)](#21-实体识别-named-entity-recognition)
  - [3. 关系抽取 (Relation Extraction)](#3-关系抽取-relation-extraction)
  - [4. 知识融合技术](#4-知识融合技术)
    - [4.1. 实体链接 (Entity Linking)](#41-实体链接-entity-linking)
  - [5. 知识对齐 (Knowledge Alignment)](#5-知识对齐-knowledge-alignment)
  - [6. 知识图谱构建流程](#6-知识图谱构建流程)
    - [6.1. 构建流水线](#61-构建流水线)
  - [7. 大规模知识图谱构建](#7-大规模知识图谱构建)
    - [7.1. 分布式构建](#71-分布式构建)
  - [8. 增量更新](#8-增量更新)
  - [9. 质量评估与优化](#9-质量评估与优化)
    - [9.1. 质量评估指标](#91-质量评估指标)
  - [10. 应用案例](#10-应用案例)
    - [10.1. 学术知识图谱构建](#101-学术知识图谱构建)
  - [11. 企业知识图谱构建](#11-企业知识图谱构建)
  - [12. 工具与平台](#12-工具与平台)
    - [12.1. 开源工具](#121-开源工具)
    - [12.2. 商业平台](#122-商业平台)
  - [13. 发展趋势](#13-发展趋势)
