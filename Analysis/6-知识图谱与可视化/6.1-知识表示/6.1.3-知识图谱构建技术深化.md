...
- [知识图谱构建技术深化](#知识图谱构建技术深化)
  - [目录](#目录)
  - [1. 知识抽取技术](#1-知识抽取技术)
    - [实体识别 (Named Entity Recognition)](#实体识别-named-entity-recognition)
    - [关系抽取 (Relation Extraction)](#关系抽取-relation-extraction)
  - [2. 知识融合技术](#2-知识融合技术)
    - [实体链接 (Entity Linking)](#实体链接-entity-linking)
    - [知识对齐 (Knowledge Alignment)](#知识对齐-knowledge-alignment)
  - [3. 知识图谱构建流程](#3-知识图谱构建流程)
    - [构建流水线](#构建流水线)
  - [4. 大规模知识图谱构建](#4-大规模知识图谱构建)
    - [分布式构建](#分布式构建)
    - [增量更新](#增量更新)
  - [5. 质量评估与优化](#5-质量评估与优化)
    - [质量评估指标](#质量评估指标)
