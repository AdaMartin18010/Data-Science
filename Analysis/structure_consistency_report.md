...
- [Analysis 文件夹结构一致性检查报告](#analysis-文件夹结构一致性检查报告)
  - [📑 目录](#-目录)
- [检查概览](#检查概览)
- [问题分类统计](#问题分类统计)
  - [1. 标题编号问题](#1-标题编号问题)
  - [2. 目录（TOC）问题](#2-目录toc问题)
  - [3. 标题层级跳跃问题](#3-标题层级跳跃问题)
- [标准格式建议](#标准格式建议)
  - [格式规范](#格式规范)
  - [不允许的格式](#不允许的格式)
- [需要修复的文件列表](#需要修复的文件列表)
  - [高优先级（混合编号 + 层级跳跃）](#高优先级混合编号-层级跳跃)
  - [中优先级（仅混合编号）](#中优先级仅混合编号)
  - [低优先级（仅层级跳跃）](#低优先级仅层级跳跃)
- [修复建议](#修复建议)
  - [阶段一：统一编号格式](#阶段一统一编号格式)
  - [阶段二：修复层级跳跃](#阶段二修复层级跳跃)
  - [阶段三：添加目录](#阶段三添加目录)
- [自动化修复工具](#自动化修复工具)
- [注意事项](#注意事项)
---
