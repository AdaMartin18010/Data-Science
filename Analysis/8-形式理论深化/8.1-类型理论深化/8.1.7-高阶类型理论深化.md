...
- [高阶类型理论深化](#高阶类型理论深化)
  - [📑 目录](#-目录)
  - [1. 高阶类型基础](#1-高阶类型基础)
    - [1.1. 高阶类型定义](#11-高阶类型定义)
    - [1.2. 高阶类型构造子](#12-高阶类型构造子)
  - [2. 类型族与关联类型](#2-类型族与关联类型)
    - [2.1. 类型族定义](#21-类型族定义)
    - [2.2. 高级类型族](#22-高级类型族)
  - [3. 高阶抽象](#3-高阶抽象)
    - [3.1. 高阶类型类](#31-高阶类型类)
    - [3.2. 高阶类型函数](#32-高阶类型函数)
  - [4. 类型级编程](#4-类型级编程)
    - [4.1. 类型级自然数](#41-类型级自然数)
    - [4.2. 类型级列表](#42-类型级列表)
    - [4.3. 类型级函数](#43-类型级函数)
  - [5. 高阶类型系统](#5-高阶类型系统)
    - [5.1. 高阶类型系统设计](#51-高阶类型系统设计)
    - [5.2. 高阶类型系统应用](#52-高阶类型系统应用)
  - [6. 高阶类型理论应用](#6-高阶类型理论应用)
    - [6.1. 高阶类型在函数式编程中的应用](#61-高阶类型在函数式编程中的应用)
    - [6.2. 高阶类型在类型安全中的应用](#62-高阶类型在类型安全中的应用)
  - [7. 工具与平台](#7-工具与平台)
    - [7.1. 高阶类型理论工具](#71-高阶类型理论工具)
    - [7.2. 类型级编程工具](#72-类型级编程工具)
    - [7.3. 高阶类型理论平台](#73-高阶类型理论平台)
  - [8. 最佳实践](#8-最佳实践)
    - [8.1. 高阶类型设计](#81-高阶类型设计)
    - [8.2. 类型级编程](#82-类型级编程)
    - [8.3. 高阶类型理论应用](#83-高阶类型理论应用)
