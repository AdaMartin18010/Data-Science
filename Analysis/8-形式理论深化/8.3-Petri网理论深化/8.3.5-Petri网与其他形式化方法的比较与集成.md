...
- [Petri网与其他形式化方法的比较与集成](#petri网与其他形式化方法的比较与集成)
  - [📑 目录](#-目录)
  - [1. 概述](#1-概述)
  - [2. Petri网与自动机理论的比较与集成](#2-petri网与自动机理论的比较与集成)
    - [2.1. 理论基础比较](#21-理论基础比较)
      - [2.1.1. 表达能力](#211-表达能力)
      - [2.1.2. 状态空间](#212-状态空间)
  - [3. 转换方法](#3-转换方法)
    - [3.1. Petri网到自动机的转换](#31-petri网到自动机的转换)
  - [4. 自动机到Petri网的转换](#4-自动机到petri网的转换)
  - [5. 集成应用](#5-集成应用)
    - [5.1. 混合建模方法](#51-混合建模方法)
  - [6. Petri网与时态逻辑的集成](#6-petri网与时态逻辑的集成)
    - [6.1. 理论基础](#61-理论基础)
      - [6.1.1. 时态逻辑表达能力](#611-时态逻辑表达能力)
    - [6.2. 模型检查集成](#62-模型检查集成)
      - [6.2.1. LTL模型检查](#621-ltl模型检查)
  - [7. CTL模型检查](#7-ctl模型检查)
  - [8. 时态逻辑扩展](#8-时态逻辑扩展)
    - [8.1. 时间Petri网与时态逻辑](#81-时间petri网与时态逻辑)
  - [9. Petri网与类型理论的集成](#9-petri网与类型理论的集成)
    - [9.1. 理论基础](#91-理论基础)
      - [9.1.1. 类型安全Petri网](#911-类型安全petri网)
    - [9.2. 依赖类型Petri网](#92-依赖类型petri网)
      - [9.2.1. 实现依赖类型系统](#921-实现依赖类型系统)
  - [10. 同伦类型理论集成](#10-同伦类型理论集成)
    - [10.1. 路径类型Petri网](#101-路径类型petri网)
  - [11. Petri网与进程代数的集成](#11-petri网与进程代数的集成)
    - [11.1. 理论基础](#111-理论基础)
      - [11.1.1. CCS到Petri网的转换](#1111-ccs到petri网的转换)
  - [12. π演算到Petri网的转换](#12-π演算到petri网的转换)
    - [12.1. 双向转换](#121-双向转换)
      - [12.1.1. Petri网到进程代数的转换](#1211-petri网到进程代数的转换)
  - [13. 统一形式化框架](#13-统一形式化框架)
    - [13.1. 理论基础](#131-理论基础)
      - [13.1.1. 多方法集成框架](#1311-多方法集成框架)
    - [13.2. 交叉验证](#132-交叉验证)
      - [13.2.1. 多方法验证](#1321-多方法验证)
  - [14. 工具实现](#14-工具实现)
    - [14.1. 集成开发环境](#141-集成开发环境)
  - [15. 应用案例](#15-应用案例)
    - [15.1. 并发系统设计](#151-并发系统设计)
      - [15.1.1. 多方法建模](#1511-多方法建模)
  - [16. 协议验证](#16-协议验证)
    - [16.1. 多方法协议验证](#161-多方法协议验证)
  - [17. 学习路径](#17-学习路径)
    - [17.1. 基础学习路径](#171-基础学习路径)
    - [17.2. 进阶学习路径](#172-进阶学习路径)
    - [17.3. 实践项目](#173-实践项目)
  - [18. 前沿研究方向](#18-前沿研究方向)
    - [18.1. 理论方向](#181-理论方向)
    - [18.2. 应用方向](#182-应用方向)
