...
| 8.3.2-高级Petri网变种深化.md | 概率论、量子计算 | 复杂系统分析 | Snoopy, TINA |
| 8.3.3-Petri网分析方法深化.md | 线性代数、图论 | 系统验证 | LoLA, MARCIE |
| 8.3.4-Petri网应用场景深化.md | 软件工程、控制理论 | 实际应用 | Yasper, Renew |
| 8.3.5-Petri网与其他理论交叉深化.md | 类型理论、量子理论 | 理论融合 | 自定义工具 |
| 8.3.6-Petri网工具与实现深化.md | 编程语言、算法 | 工具开发 | 多种实现 |
