...
- [8.3.2-高级Petri网变种深化](#832-高级petri网变种深化)
  - [📑 目录](#-目录)
  - [1. 理论综述](#1-理论综述)
    - [1.1. 高级Petri网的主要变种](#11-高级petri网的主要变种)
  - [2. 有色Petri网（CPN）](#2-有色petri网cpn)
    - [2.1. 理论定义](#21-理论定义)
    - [2.2. 代码实现](#22-代码实现)
  - [3. 应用实例：通信协议建模](#3-应用实例通信协议建模)
  - [4. 时间Petri网（TPN）](#4-时间petri网tpn)
    - [4.1. 理论定义2](#41-理论定义2)
    - [4.2. 代码实现2](#42-代码实现2)
  - [5. 应用实例：实时控制系统](#5-应用实例实时控制系统)
  - [6. 概率Petri网（SPN）](#6-概率petri网spn)
    - [6.1. 理论定义3](#61-理论定义3)
    - [6.2. 代码实现3](#62-代码实现3)
  - [7. 应用实例：排队系统](#7-应用实例排队系统)
  - [8. 模糊Petri网（FPN）](#8-模糊petri网fpn)
    - [8.1. 理论定义4](#81-理论定义4)
    - [8.2. 代码实现4](#82-代码实现4)
  - [9. 应用实例：模糊控制系统](#9-应用实例模糊控制系统)
  - [10. 总结](#10-总结)
