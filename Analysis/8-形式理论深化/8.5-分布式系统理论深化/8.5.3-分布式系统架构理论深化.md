...
- [8.5.3 分布式系统架构理论深化](#853-分布式系统架构理论深化)
  - [📑 目录](#-目录)
  - [1. 微服务架构](#1-微服务架构)
    - [1.1. 微服务基础概念](#11-微服务基础概念)
    - [1.2. 服务间通信](#12-服务间通信)
  - [2. 服务网格](#2-服务网格)
  ...
  - [5. 事件溯源](#5-事件溯源)
  - [6. CQRS模式](#6-cqrs模式)
    - [6.1. 命令查询职责分离](#61-命令查询职责分离)
  - [7. 应用案例](#7-应用案例)
    - [7.1. 电商微服务架构](#71-电商微服务架构)
  - [8. 分布式日志系统](#8-分布式日志系统)
  - [9. 工具实现](#9-工具实现)
    - [9.1. Python分布式架构工具](#91-python分布式架构工具)
    - [9.2. JavaScript分布式架构实现](#92-javascript分布式架构实现)
  - [10. 学习路径](#10-学习路径)
    - [10.1. 基础学习](#101-基础学习)
    - [10.2. 进阶学习](#102-进阶学习)
    - [10.3. 应用实践](#103-应用实践)
