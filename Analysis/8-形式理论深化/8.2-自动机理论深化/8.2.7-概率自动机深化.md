...
- [概率自动机深化](#概率自动机深化)
  - [📑 目录](#-目录)
  - [1. 概率自动机基础](#1-概率自动机基础)
    - [1.1. 概率自动机定义](#11-概率自动机定义)
  - [2. 概率自动机类型](#2-概率自动机类型)
  - [3. 马尔可夫链](#3-马尔可夫链)
    - [3.1. 马尔可夫链实现](#31-马尔可夫链实现)
  - [4. 马尔可夫链分析](#4-马尔可夫链分析)
  - [5. 隐马尔可夫模型](#5-隐马尔可夫模型)
    - [5.1. HMM基础实现](#51-hmm基础实现)
  - [6. 概率图灵机](#6-概率图灵机)
    - [6.1. 概率图灵机实现](#61-概率图灵机实现)
  - [7. 随机自动机](#7-随机自动机)
    - [7.1. 随机自动机实现](#71-随机自动机实现)
  - [8. 工具与平台](#8-工具与平台)
    - [8.1. 概率自动机工具](#81-概率自动机工具)
    - [8.2. 马尔可夫链工具](#82-马尔可夫链工具)
    - [8.3. 隐马尔可夫模型工具](#83-隐马尔可夫模型工具)
  - [9. 最佳实践](#9-最佳实践)
    - [9.1. 概率自动机设计](#91-概率自动机设计)
    - [9.2. 马尔可夫链分析1](#92-马尔可夫链分析1)
    - [9.3. 隐马尔可夫模型应用](#93-隐马尔可夫模型应用)
