...
- [SQL最佳实践指南](#sql最佳实践指南)
  ...
  - [二、SQL编码最佳实践](#二sql编码最佳实践)
    - [2.1 命名规范](#21-命名规范)
      - [2.1.1 表命名规范](#211-表命名规范)
      - [2.1.2 列命名规范](#212-列命名规范)
      - [2.1.3 索引命名规范](#213-索引命名规范)
    - [2.2 代码风格](#22-代码风格)
      - [2.2.1 缩进格式](#221-缩进格式)
      - [2.2.2 关键字大小写](#222-关键字大小写)
      - [2.2.3 代码组织](#223-代码组织)
    - [2.3 注释规范](#23-注释规范)
      - [2.3.1 单行注释](#231-单行注释)
      - [2.3.2 多行注释](#232-多行注释)
    - [2.4 错误处理](#24-错误处理)
      ...
      - [2.4.2 数据验证](#242-数据验证)
    - [2.5 性能考虑](#25-性能考虑)
      - [2.5.1 避免SELECT \*](#251-避免select-)
      - [2.5.2 使用索引](#252-使用索引)
      - [2.5.3 避免N+1查询](#253-避免n1查询)
      - [2.5.4 批量操作](#254-批量操作)
  - [三、数据库设计最佳实践](#三数据库设计最佳实践)
    - [3.1 表设计原则](#31-表设计原则)
      - [3.1.1 范式设计](#311-范式设计)
      - [3.1.2 数据类型选择](#312-数据类型选择)
    - [3.2 索引设计原则](#32-索引设计原则)
      - [3.2.1 索引选择决策树](#321-索引选择决策树)
      - [3.2.2 复合索引设计](#322-复合索引设计)
    - [3.3 约束设计原则](#33-约束设计原则)
      - [3.3.1 主键设计](#331-主键设计)
      - [3.3.2 外键设计](#332-外键设计)
    - [3.4 安全设计原则](#34-安全设计原则)
      - [3.4.1 SQL注入防护](#341-sql注入防护)
      - [3.4.2 权限控制](#342-权限控制)
  - [四、性能调优最佳实践](#四性能调优最佳实践)
    - [4.1 监控指标](#41-监控指标)
      - [4.1.1 查询性能指标](#411-查询性能指标)
      - [4.1.2 资源使用指标](#412-资源使用指标)
    - [4.2 调优流程](#42-调优流程)
      - [4.2.1 性能调优决策树](#421-性能调优决策树)
      - [4.2.2 调优步骤](#422-调优步骤)
    - [4.3 问题诊断](#43-问题诊断)
      - [4.3.1 慢查询分析](#431-慢查询分析)
      - [4.3.2 统计信息分析](#432-统计信息分析)
    - [4.4 优化策略](#44-优化策略)
      - [4.4.1 索引优化策略](#441-索引优化策略)
      - [4.4.2 查询重写策略](#442-查询重写策略)
  - [五、相关资源](#五相关资源)
    - [相关文档](#相关文档)
