...
- [Serverless 部署指南](#serverless-部署指南)
  ...
  - [8. Neon详细配置和优化](#8-neon详细配置和优化)
    - [8.1 生产环境配置](#81-生产环境配置)
    - [8.2 性能优化配置](#82-性能优化配置)
    - [8.3 成本优化策略](#83-成本优化策略)
    - [8.4 监控和告警配置](#84-监控和告警配置)
  - [9. Supabase详细配置](#9-supabase详细配置)
    - [9.1 生产环境配置](#91-生产环境配置)
    - [9.2 实时功能配置](#92-实时功能配置)
    - [9.3 存储集成配置](#93-存储集成配置)
    - [9.4 安全配置](#94-安全配置)
  - [10. AWS RDS Serverless v2详细配置](#10-aws-rds-serverless-v2详细配置)
    - [10.1 生产环境配置](#101-生产环境配置)
    - [10.2 自动扩缩容配置](#102-自动扩缩容配置)
    - [10.3 高可用配置](#103-高可用配置)
    - [10.4 监控和告警配置](#104-监控和告警配置)
  - [11. 迁移到 Serverless](#11-迁移到-serverless)
    - [11.1 从自建 PostgreSQL 迁移](#111-从自建-postgresql-迁移)
      - [使用 pg\_dump](#使用-pg_dump)
      - [使用逻辑复制](#使用逻辑复制)
    - [11.2 迁移检查清单](#112-迁移检查清单)
    - [11.3 迁移后验证和优化](#113-迁移后验证和优化)
  - [12. 深入阅读](#12-深入阅读)
    - [相关文档](#相关文档)
      - [部署架构](#部署架构)
      - [前沿技术](#前沿技术)
...
# 3. 性能测试
psql -h ep-xxx.neon.tech -U user -d neondb -c "EXPLAIN ANALYZE SELECT * FROM table_name WHERE id = 1;"
...
## 10. AWS RDS Serverless v2详细配置

### 10.1 生产环境配置

**生产级RDS Serverless v2配置**:

```bash
# 创建生产级Serverless v2集群
aws rds create-db-cluster \
...
- ⭐⭐⭐ [云原生与容器化](./05.12-云原生与容器化.md) - 云原生架构
- ⭐⭐⭐ [Kubernetes 部署指南](./05.13-Kubernetes部署.md) - Kubernetes部署
- ⭐⭐ [Docker 部署指南](./05.12-Docker部署.md) - Docker部署

#### 前沿技术

- ⭐⭐⭐ [Serverless 与分支](../../07-前沿技术/AI-时代/03-Serverless与分支-Neon与Supabase.md) - Serverless架构与分支功能
