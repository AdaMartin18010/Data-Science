...
- [事务管理与ACID特性](../01-核心基础/01.04-事务管理与ACID特性.md) - 事务理论基础
- [并发控制与MVCC机制](../01-核心基础/01.05-并发控制与MVCC机制.md) - 并发控制机制
- [分布式架构设计](../04-部署运维/04.07-分布式架构设计.md) - 分布式架构
- [集群部署与高可用](../04-部署运维/04.02-集群部署与高可用.md) - 高可用架构
- [形式化验证方法](../05-前沿技术/05.07-形式化验证方法.md) - 分布式协议形式化验证
