...
- [统计信息与代价模型](#统计信息与代价模型)
  ...
  - [13. Wikidata对齐](#13-wikidata对齐)
    - [13.1 统计信息概念对齐](#131-统计信息概念对齐)
    - [13.2 PostgreSQL统计信息对齐](#132-postgresql统计信息对齐)
  - [14. 形式证明与理论论证](#14-形式证明与理论论证)
    - [14.1 选择性估计准确性证明](#141-选择性估计准确性证明)
    - [14.2 代价模型最优性证明](#142-代价模型最优性证明)
    - [14.3 统计信息更新必要性证明](#143-统计信息更新必要性证明)
...
- ⭐⭐ [存储管理与数据持久化](../../01-核心基础/01.06-存储管理与数据持久化.md) - 列存储统计信息、列存储代价估算🆕
- ⭐⭐ [数据分析完整指南](../../09-应用设计/数据模型设计/09.01-数据分析完整指南.md) - 统计分析实践
- ⭐⭐ [性能调优实践](../../05-部署架构/单机部署/05.02-性能调优实践.md) - 性能调优详细指南
- ⭐ [监控与诊断](../../06-运维实践/监控与诊断/06.01-监控与诊断.md) - 统计信息监控
