...
- [Azure AI扩展实战](#azure-ai扩展实战)
  ...
  - [5. 基础功能使用](#5-基础功能使用)
    - [5.1 生成文本嵌入](#51-生成文本嵌入)
    - [5.2 语义搜索](#52-语义搜索)
    - [5.3 Azure认知服务集成](#53-azure认知服务集成)
  - [6. 实战案例](#6-实战案例)
    - [6.1 智能文档检索系统](#61-智能文档检索系统)
    - [6.2 多语言客服系统](#62-多语言客服系统)
  - [7. 性能优化](#7-性能优化)
    - [7.1 批量处理优化](#71-批量处理优化)
    - [7.2 成本控制](#72-成本控制)
    - [7.3 缓存策略](#73-缓存策略)
  - [8. 故障排查](#8-故障排查)
    - [8.1 常见问题和解决方案](#81-常见问题和解决方案)
      - [问题1: 扩展安装失败](#问题1-扩展安装失败)
      - [问题2: API调用超时](#问题2-api调用超时)
      - [问题3: 限流错误 (429 Too Many Requests)](#问题3-限流错误-429-too-many-requests)
      - [问题4: 配置丢失](#问题4-配置丢失)
  - [9. 性能基准](#9-性能基准)
    - [9.1 嵌入生成性能](#91-嵌入生成性能)
    - [9.2 成本估算](#92-成本估算)
  - [10. 参考资源](#10-参考资源)
    - [10.1 官方文档](#101-官方文档)
    - [10.2 相关文档](#102-相关文档)
