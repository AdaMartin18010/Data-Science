...
# 需要系统支持io_uring（Linux 5.1+）
io_uring = on                           # 启用io_uring（如果支持）
...
- [PostgreSQL安装文档](https://www.postgresql.org/docs/current/installation.html)
- [PostgreSQL配置文档](https://www.postgresql.org/docs/current/config-setting.html)
...
- [PostgreSQL配置优化](https://www.postgresql.org/docs/current/runtime-config.html)
