...
- [03 Serverless 与分支（Neon / Supabase）](#03-serverless-与分支neon--supabase)
  ...
  - [🎯 核心结论](#-核心结论)
  - [能力与边界](#能力与边界)
    - [Serverless 特性](#serverless-特性)
    - [Branching（分支）特性](#branching分支特性)
    - [边界与限制](#边界与限制)
  - [典型架构](#典型架构)
    - [1. RAG 语料分支管理](#1-rag-语料分支管理)
    - [2. Agent 实验分支](#2-agent-实验分支)
    - [3. 元数据表设计](#3-元数据表设计)
  - [冷启动风险与缓解策略](#冷启动风险与缓解策略)
    - [冷启动延迟分析](#冷启动延迟分析)
    - [缓解策略](#缓解策略)
