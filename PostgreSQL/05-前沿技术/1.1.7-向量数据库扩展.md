...
> - [向量数据库支持](../03-高级特性/03.05-向量数据库支持.md) (PG 18+ ⭐)

## 目录

- [PostgreSQL向量数据库扩展](#postgresql向量数据库扩展)
  - [目录](#目录)
  - [1. 概述](#1-概述)
  - [2. 向量数据库基础](#2-向量数据库基础)
    - [2.1 向量嵌入](#21-向量嵌入)
  ...
  - [8. PostgreSQL 18 新特性 ⭐](#8-postgresql-18-新特性-)
    - [8.1 异步 I/O 子系统](#81-异步-io-子系统)
    - [8.2 虚拟生成列](#82-虚拟生成列)
    - [8.3 pgvector 2.0 新特性](#83-pgvector-20-新特性)
    - [8.4 性能对比](#84-性能对比)
  - [9. 参考文献](#9-参考文献)
...
4. Malkov, Y. A., & Yashunin, D. A. (2018). _Efficient and robust approximate nearest neighbor search using Hierarchical Navigable Small World graphs_. IEEE transactions on pattern analysis and machine intelligence.
5. Johnson, J., Douze, M., & Jégou, H. (2019). _Billion-scale similarity search with GPUs_. IEEE Transactions on Big Data.
6. [AI 时代专题](../ai_view.md) ⭐⭐⭐ (v3.0, 2025-11-11)
