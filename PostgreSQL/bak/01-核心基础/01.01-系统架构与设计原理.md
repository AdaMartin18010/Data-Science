...
> 📅 **最后更新**: 2025-10-30
> 🎯 **文档目标**: 深入理解PostgreSQL的系统架构、进程模型和核心设计原理

> 🆕 **PostgreSQL 17架构改进**
>
> PostgreSQL 17在系统架构方面带来以下改进：
>
...
3. PostgreSQL Global Development Group. (2024). PostgreSQL 17 Release Notes. <https://www.postgresql.org/docs/17/release-17.html>
...
**PostgreSQL 17相关**: 参见 `PostgreSQL-17-新特性速查.md` 了解增量备份、动态共享内存等架构改进。
