...
>
> - 🚀 [向量检索性能调优指南](../05-前沿技术/05.05-向量检索性能调优指南.md) - 完整的性能调优方法 (PG 18+ ⭐)
...
- 📊 [向量检索性能调优指南](../05-前沿技术/05.05-向量检索性能调优指南.md) - HNSW vs IVFFlat对比、参数调优、性能基准
- 🔍 [向量与混合搜索](../05-前沿技术/AI-时代/01-向量与混合搜索-pgvector与RRF.md) - pgvector 2.0 + RRF 融合算法

### 实战应用

- 🚀 [RAG架构实战指南](../05-前沿技术/05.04-RAG架构实战指南.md) - 完整的RAG系统实现
- 🛠️ [向量检索落地指南](../runbook/04-向量检索与混合查询-落地指南.md) - 生产部署最佳实践
- 📋 [AI 时代专题](../ai_view.md) - PostgreSQL在AI时代的全面演进

### 相关主题

- [查询优化器原理](../02-查询处理/02.01-查询优化器原理.md) - 查询优化基础
- [索引结构与优化](../02-查询处理/02.02-索引结构与优化.md) - 索引设计原理
- [执行计划与性能调优](../02-查询处理/02.04-执行计划与性能调优.md) - 性能分析
