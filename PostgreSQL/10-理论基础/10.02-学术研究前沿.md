...
- ⭐⭐ [数据建模完整指南](../09-应用设计/数据模型设计/09.02-数据建模完整指南.md) - 数据建模研究
- ⭐⭐ [数据仓库设计指南](../09-应用设计/数据模型设计/09.03-数据仓库设计指南.md) - 数据仓库研究
- ⭐ [数据分析完整指南](../09-应用设计/数据模型设计/09.01-数据分析完整指南.md) - 数据分析研究

### 核心课程

- ⭐⭐ [查询优化器原理](../03-查询与优化/02.01-查询优化器原理.md) - 查询优化研究
- ⭐ [并发控制与MVCC机制](../01-核心课程/01.05-并发控制与MVCC机制.md) - 并发控制研究
