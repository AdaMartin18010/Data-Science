...
> 对齐：`../../05-部署架构/单机部署/05.04-监控与诊断.md`
...
- [日志与可观测性-落地指南（Runbook）](#日志与可观测性-落地指南runbook)
  - [📋 目录](#-目录)
  - [1. 日志配置建议](#1-日志配置建议)
    - [1.1 完整日志配置](#11-完整日志配置)
    - [1.2 日志格式说明](#12-日志格式说明)
  - [2. 日志采集](#2-日志采集)
    - [2.1 Filebeat配置](#21-filebeat配置)
    - [2.2 Vector配置](#22-vector配置)
    - [2.3 慢SQL归一化](#23-慢sql归一化)
  - [3. 面板与告警](#3-面板与告警)
    - [3.1 Grafana仪表板设计](#31-grafana仪表板设计)
    - [3.2 告警规则配置](#32-告警规则配置)
  - [4. 关联追踪](#4-关联追踪)
    - [4.1 应用追踪配置](#41-应用追踪配置)
    - [4.2 慢SQL到服务映射](#42-慢sql到服务映射)
    - [4.3 分布式追踪集成](#43-分布式追踪集成)
