...
BEGIN
    ...
    IF NOT FOUND THEN
        RAISE EXCEPTION 'From account not found or inactive: %', p_from_account_id;
    END IF;
    ...
    IF NOT FOUND THEN
        RAISE EXCEPTION 'Account version mismatch, please retry';
    END IF;
    ...
    IF NOT FOUND THEN
        RAISE EXCEPTION 'To account not found or inactive: %', p_to_account_id;
    END IF;
