...
> 🆕 **PostgreSQL 18存储改进**: 异步I/O子系统（I/O性能提升2-3倍，已详细展开）、增量备份（节省94%时间，已详细展开）、WAL汇总机制、动态共享内存（提升20%效率）
...
- [备份与恢复](../06-运维实践/备份与恢复/06.06-备份与恢复.md) - 数据持久化实践
- [性能调优实践](../05-部署架构/单机部署/05.02-性能调优实践.md) - 存储性能优化

### 12.2 实战案例与示例

- [可运行示例项目](../examples/README.md) ⭐ - 8个完整的Docker Compose示例
- [Docker部署指南](../05-部署架构/容器化部署/05.12-Docker部署.md) - 存储配置实践
- [备份与恢复实践](../06-运维实践/备份与恢复/06.07-增量备份与恢复.md) - PostgreSQL 18增量备份
...
- ⭐⭐ [性能调优实践](../../05-部署架构/单机部署/05.02-性能调优实践.md) - 存储性能调优
