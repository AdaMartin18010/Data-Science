...
- ⭐⭐⭐ [并发控制与MVCC机制](./01.05-并发控制与MVCC机制.md) - MVCC实现机制
- ⭐⭐⭐ [存储管理与数据持久化](./01.06-存储管理与数据持久化.md) - WAL机制
- ⭐⭐ [SQL语言规范与标准](./01.03-SQL语言规范与标准.md) - 事务SQL语句
- ⭐⭐ [系统架构与设计原理](./01.01-系统架构与设计原理.md) - 系统架构理论基础
- ⭐⭐ [金融账务一致性](../../09-应用设计/行业案例/金融账务一致性.md) - 事务应用案例
- ⭐ [备份与恢复](../../06-运维实践/备份与恢复/06.06-备份与恢复.md) - 事务恢复实践
