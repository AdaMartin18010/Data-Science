...
```sql
-- 普通VACUUM：清理死元组，不阻塞查询
VACUUM employees;

-- VACUUM ANALYZE：清理死元组并更新统计信息
VACUUM ANALYZE employees;

-- VACUUM FULL：完全重建表，阻塞查询
...
- ⭐⭐ [性能调优实践](../../05-部署架构/单机部署/05.02-性能调优实践.md) - 并发性能调优
- ⭐⭐ [监控与诊断](../../06-运维实践/监控与诊断/06.01-监控与诊断.md) - 锁监控
- ⭐ [性能问题案例库](../../06-运维实践/监控与诊断/06.04-性能问题案例库.md) - 锁问题案例
