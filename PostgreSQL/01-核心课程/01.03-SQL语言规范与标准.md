...
- [PostgreSQL SQL语言规范与标准](#postgresql-sql语言规范与标准)
  - [📋 目录](#-目录)
  - [1. 定义与形式化](#1-定义与形式化)
    - [1.1 概念定义](#11-概念定义)
    - [1.2 形式化定义](#12-形式化定义)
  ...
  - [2. 核心语法规范](#2-核心语法规范)
    ...
    - [2.2 数据操作语言（DML）](#22-数据操作语言dml)
      ...
      - [2.2.2 更新操作](#222-更新操作)
      - [2.2.3 删除操作](#223-删除操作)
    - [2.3 数据查询语言（DQL）](#23-数据查询语言dql)
      - [2.3.1 基本查询](#231-基本查询)
      - [2.3.2 连接查询](#232-连接查询)
      - [2.3.3 子查询](#233-子查询)
    - [2.4 高级查询特性](#24-高级查询特性)
      - [2.4.1 窗口函数](#241-窗口函数)
      - [2.4.2 递归查询](#242-递归查询)
      - [2.4.3 公共表表达式（CTE）](#243-公共表表达式cte)
    - [2.5 事务控制语言（TCL）](#25-事务控制语言tcl)
      - [2.5.1 事务管理](#251-事务管理)
    - [2.6 数据控制语言（DCL）](#26-数据控制语言dcl)
      - [2.6.1 权限管理](#261-权限管理)
  - [3. PostgreSQL扩展特性](#3-postgresql扩展特性)
    - [3.1 数据类型扩展](#31-数据类型扩展)
    - [3.2 函数和操作符](#32-函数和操作符)
    - [3.3 索引类型](#33-索引类型)
  - [4. 性能优化](#4-性能优化)
    - [4.1 查询优化](#41-查询优化)
    - [4.2 索引优化](#42-索引优化)
