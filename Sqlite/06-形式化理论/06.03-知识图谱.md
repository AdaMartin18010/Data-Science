...
- [知识图谱：SQLite概念关系与知识体系](#知识图谱sqlite概念关系与知识体系)
  ...
  - [7. 学习路径](#7-学习路径)
    ...
    - [7.2. 进阶路径](#72-进阶路径)
    - [7.3. 专家路径](#73-专家路径)
  - [8. 知识图谱多维对比矩阵](#8-知识图谱多维对比矩阵)
    - [8.1. 知识体系层次对比矩阵](#81-知识体系层次对比矩阵)
    - [8.2. 学习路径对比矩阵](#82-学习路径对比矩阵)
    - [8.3. 概念关系类型对比矩阵](#83-概念关系类型对比矩阵)
  - [9. 概念索引](#9-概念索引)
    - [9.1. 按主题分类](#91-按主题分类)
    - [9.2. 按难度分类](#92-按难度分类)
  - [10. 🔗 相关资源](#10--相关资源)
  - [11. 🔗 交叉引用](#11--交叉引用)
    - [11.1. 理论模型 🆕](#111-理论模型-)
    - [11.2. 设计模型 🆕](#112-设计模型-)
    - [11.3. 知识图谱文档 🆕](#113-知识图谱文档-)
    - [11.4. 形式化理论文档 🆕](#114-形式化理论文档-)
    - [11.5. 核心架构文档 🆕](#115-核心架构文档-)
  - [12. 📚 参考资料](#12--参考资料)
...
- ⭐⭐⭐ [知识图谱与概念关系网络](../09-最新特性/09.03-SQLite知识图谱与概念关系网络.md) - 扩展知识图谱（400+概念，500+关系）
- ⭐⭐ [文档依赖关系图](../00-项目导航/06-文档依赖关系图.md) - 知识路径图

### 11.4. 形式化理论文档 🆕

- ⭐⭐⭐ [形式化论证框架总览](./06.05-SQLite形式化论证框架总览.md) - 五层形式化体系
- ⭐⭐ [定理依赖关系图谱](./06.06-SQLite定理依赖关系图谱.md) - 定理依赖关系
