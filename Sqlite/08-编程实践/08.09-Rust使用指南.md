...
- [SQLite Rust使用指南](#sqlite-rust使用指南)
  ...
  - [5. sqlx（异步）](#5-sqlx异步)
    - [5.1. 安装和使用](#51-安装和使用)
    - [5.2. 异步操作](#52-异步操作)
    - [5.3. 编译时SQL检查](#53-编译时sql检查)
  - [6. 高级特性](#6-高级特性)
    - [6.1. 自定义函数](#61-自定义函数)
    - [6.2. 自定义聚合函数](#62-自定义聚合函数)
    - [6.3. 连接钩子](#63-连接钩子)
  - [7. ORM框架](#7-orm框架)
    - [7.1. Diesel](#71-diesel)
    - [7.2. Sea-ORM](#72-sea-orm)
  - [8. Rust库多维对比矩阵](#8-rust库多维对比矩阵)
    - [8.1. Rust SQLite库对比矩阵](#81-rust-sqlite库对比矩阵)
    - [8.2. Rust使用方式对比矩阵](#82-rust使用方式对比矩阵)
    - [8.3. Rust最佳实践对比矩阵](#83-rust最佳实践对比矩阵)
  - [9. 最佳实践](#9-最佳实践)
    - [9.1. 错误处理](#91-错误处理)
    - [9.2. 性能优化](#92-性能优化)
    - [9.3. 线程安全](#93-线程安全)
