...
- [事务管理：批量操作与性能优化](#事务管理批量操作与性能优化)
  ...
  - [一、基本事务控制](#一基本事务控制)
    ...
    - [1.2 事务类型](#12-事务类型)
  - [二、批量操作优化](#二批量操作优化)
    - [2.1 批量插入性能对比](#21-批量插入性能对比)
    - [2.2 批量更新优化](#22-批量更新优化)
    - [2.3 批量操作最佳实践](#23-批量操作最佳实践)
  - [三、SAVEPOINT嵌套事务](#三savepoint嵌套事务)
    - [3.1 SAVEPOINT概述](#31-savepoint概述)
    - [3.2 应用场景](#32-应用场景)
  - [四、事务边界设计](#四事务边界设计)
    - [4.1 事务粒度](#41-事务粒度)
    - [4.2 事务边界原则](#42-事务边界原则)
  - [五、事务性能优化](#五事务性能优化)
    - [5.1 批量事务优化](#51-批量事务优化)
    - [5.2 预编译语句](#52-预编译语句)
  - [六、事务错误处理](#六事务错误处理)
    - [6.1 错误码处理](#61-错误码处理)
    - [6.2 Python错误处理](#62-python错误处理)
  - [七、事务管理多维对比矩阵](#七事务管理多维对比矩阵)
    - [7.1 事务类型多维对比矩阵](#71-事务类型多维对比矩阵)
    - [7.2 批量操作策略对比矩阵](#72-批量操作策略对比矩阵)
    - [7.3 SAVEPOINT vs 嵌套事务对比矩阵](#73-savepoint-vs-嵌套事务对比矩阵)
    - [7.4 事务最佳实践](#74-事务最佳实践)
    - [7.4.1 事务设计原则](#741-事务设计原则)
