...
- [SQLite Python使用指南](#sqlite-python使用指南)
  ...
  - [📑 目录](#-目录)
  - [📊 思维导图](#-思维导图)
  - [一、标准库sqlite3](#一标准库sqlite3)
    - [1.1 基本连接](#11-基本连接)
    - [1.2 基本操作](#12-基本操作)
    - [1.3 事务管理](#13-事务管理)
    - [1.4 预编译语句](#14-预编译语句)
    - [1.5 上下文管理器](#15-上下文管理器)
  - [二、异步库aiosqlite](#二异步库aiosqlite)
    - [2.1 异步连接](#21-异步连接)
    - [2.2 异步操作](#22-异步操作)
    - [2.3 异步事务](#23-异步事务)
  - [三、ORM框架SQLAlchemy](#三orm框架sqlalchemy)
    - [3.1 SQLAlchemy Core](#31-sqlalchemy-core)
    - [3.2 SQLAlchemy ORM](#32-sqlalchemy-orm)
    - [3.3 模型定义](#33-模型定义)
  - [四、高级特性](#四高级特性)
    - [4.1 自定义函数](#41-自定义函数)
    - [4.2 自定义聚合函数](#42-自定义聚合函数)
    - [4.3 行工厂（Row Factory）](#43-行工厂row-factory)
    - [4.4 连接池](#44-连接池)
  - [五、性能优化](#五性能优化)
    - [5.1 批量操作](#51-批量操作)
    - [5.2 索引优化](#52-索引优化)
    - [5.3 WAL模式配置](#53-wal模式配置)
  - [六、Python库多维对比矩阵](#六python库多维对比矩阵)
    - [6.1 Python SQLite库对比矩阵](#61-python-sqlite库对比矩阵)
    - [6.2 Python使用方式对比矩阵](#62-python使用方式对比矩阵)
    - [6.3 Python最佳实践对比矩阵](#63-python最佳实践对比矩阵)
  - [七、最佳实践](#七最佳实践)
    - [7.1 连接管理](#71-连接管理)
    - [7.2 错误处理](#72-错误处理)
    - [7.3 线程安全](#73-线程安全)
