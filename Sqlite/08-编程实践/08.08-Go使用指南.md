...
- [SQLite Go使用指南](#sqlite-go使用指南)
  ...
  - [1. 📑 目录](#1--目录)
  - [3. 📊 思维导图](#3--思维导图)
  - [4. database/sql + go-sqlite3（推荐）](#4-databasesql--go-sqlite3推荐)
    - [4.1. 安装和基本使用](#41-安装和基本使用)
    - [4.2. 基本操作](#42-基本操作)
    - [4.3. 事务管理](#43-事务管理)
    - [4.4. 预编译语句](#44-预编译语句)
    - [4.5. 连接池配置](#45-连接池配置)
  - [5. modernc.org/sqlite（纯Go）](#5-moderncorgsqlite纯go)
    - [5.1. 安装和使用](#51-安装和使用)
    - [5.2. 性能对比](#52-性能对比)
    - [5.3. 适用场景](#53-适用场景)
  - [6. crawshaw.io/sqlite（低级API）](#6-crawshawiosqlite低级api)
    - [6.1. 直接API调用](#61-直接api调用)
    - [6.2. 性能优化](#62-性能优化)
  - [7. GORM集成](#7-gorm集成)
    - [7.1. GORM基本使用](#71-gorm基本使用)
    - [7.2. 模型定义](#72-模型定义)
    - [7.3. 高级查询](#73-高级查询)
  - [8. 高级特性](#8-高级特性)
    - [8.1. 自定义函数](#81-自定义函数)
    - [8.2. 连接钩子](#82-连接钩子)
    - [8.3. WAL模式配置](#83-wal模式配置)
  - [9. Go库多维对比矩阵](#9-go库多维对比矩阵)
    - [9.1. Go SQLite库对比矩阵](#91-go-sqlite库对比矩阵)
    - [9.2. Go使用方式对比矩阵](#92-go使用方式对比矩阵)
    - [9.3. Go最佳实践对比矩阵](#93-go最佳实践对比矩阵)
  - [10. 最佳实践](#10-最佳实践)
    - [10.1. 连接管理](#101-连接管理)
    - [10.2. 错误处理](#102-错误处理)
    - [10.3. 性能优化](#103-性能优化)
