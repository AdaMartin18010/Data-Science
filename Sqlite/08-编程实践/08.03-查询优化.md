...
- [查询优化：预编译语句与执行计划分析](#查询优化预编译语句与执行计划分析)
  ...
  - [六、查询优化多维对比矩阵](#六查询优化多维对比矩阵)
    - [6.1 查询方式多维对比矩阵](#61-查询方式多维对比矩阵)
    - [6.2 参数绑定方式对比矩阵](#62-参数绑定方式对比矩阵)
    - [6.3 查询优化策略对比矩阵](#63-查询优化策略对比矩阵)
    - [6.4 JOIN优化策略对比矩阵](#64-join优化策略对比矩阵)
  - [七、查询优化最佳实践](#七查询优化最佳实践)
    - [7.1 查询设计原则](#71-查询设计原则)
