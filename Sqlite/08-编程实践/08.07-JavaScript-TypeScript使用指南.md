...
- [SQLite JavaScript/TypeScript使用指南](#sqlite-javascripttypescript使用指南)
  ...
  - [📑 目录](#-目录)
  - [3. 📊 思维导图](#3--思维导图)
  - [4. better-sqlite3（推荐）](#4-better-sqlite3推荐)
    - [4.1. 安装和基本使用](#41-安装和基本使用)
  - [5. 基本操作](#5-基本操作)
    - [5.1. 事务管理](#51-事务管理)
    - [5.2. 预编译语句](#52-预编译语句)
    - [5.3. 性能优化](#53-性能优化)
  - [6. node-sqlite3（异步）](#6-node-sqlite3异步)
    - [6.1. 安装和连接](#61-安装和连接)
    - [6.2. 异步操作](#62-异步操作)
    - [6.3. Promise封装](#63-promise封装)
  - [7. sql.js（浏览器/WebAssembly）](#7-sqljs浏览器webassembly)
    - [7.1. 浏览器环境使用](#71-浏览器环境使用)
    - [7.2. 文件操作](#72-文件操作)
    - [7.3. 性能考虑](#73-性能考虑)
  - [8. TypeScript支持](#8-typescript支持)
    - [8.1. better-sqlite3类型定义](#81-better-sqlite3类型定义)
    - [8.2. 类型安全查询](#82-类型安全查询)
    - [8.3. 自定义类型](#83-自定义类型)
  - [9. ORM框架](#9-orm框架)
    - [9.1. TypeORM](#91-typeorm)
    - [9.2. Sequelize](#92-sequelize)
    - [9.3. Prisma](#93-prisma)
  - [10. JavaScript/TypeScript库多维对比矩阵](#10-javascripttypescript库多维对比矩阵)
    - [10.1. JavaScript/TypeScript SQLite库对比矩阵](#101-javascripttypescript-sqlite库对比矩阵)
    - [10.2. JavaScript/TypeScript ORM框架对比矩阵](#102-javascripttypescript-orm框架对比矩阵)
    - [10.3. JavaScript/TypeScript使用方式对比矩阵](#103-javascripttypescript使用方式对比矩阵)
  - [11. 最佳实践](#11-最佳实践)
    - [11.1. 连接管理](#111-连接管理)
    - [11.2. 错误处理](#112-错误处理)
    - [11.3. 性能优化](#113-性能优化)
...
```mermaid
mindmap
  root((JavaScript/TypeScript使用指南))
    better-sqlite3推荐
      安装和基本使用
        npm安装
        基本连接
...
## 10. JavaScript/TypeScript库多维对比矩阵

### 10.1. JavaScript/TypeScript SQLite库对比矩阵
...
### 10.2. JavaScript/TypeScript ORM框架对比矩阵
...
### 10.3. JavaScript/TypeScript使用方式对比矩阵
