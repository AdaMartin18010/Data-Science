...
- [编译执行模型：SQL → 字节码 → 磁盘操作](#编译执行模型sql--字节码--磁盘操作)
  ...
  - [📊 思维导图](#-思维导图)
  - [📊 多维概念矩阵对比](#-多维概念矩阵对比)
    - [编译阶段组件对比矩阵](#编译阶段组件对比矩阵)
    - [执行引擎组件对比矩阵](#执行引擎组件对比矩阵)
    - [优化策略对比矩阵](#优化策略对比矩阵)
  - [🌐 Wikipedia对齐](#-wikipedia对齐)
    - [编译器概念对齐](#编译器概念对齐)
    - [虚拟机概念对齐](#虚拟机概念对齐)
    - [SQLite编译执行模型对齐](#sqlite编译执行模型对齐)
  - [一、架构总览](#一架构总览)
  ...
  - [四、完整执行流程示例](#四完整执行流程示例)
    ...
    - [4.2 编译阶段详解](#42-编译阶段详解)
      - [4.2.1 词法分析（Tokenizer）](#421-词法分析tokenizer)
      - [4.2.2 语法分析（Parser）](#422-语法分析parser)
      - [4.2.3 代码生成（Code Generator）](#423-代码生成code-generator)
    - [4.3 执行阶段详解](#43-执行阶段详解)
      - [4.3.1 VDBE解释执行](#431-vdbe解释执行)
      - [4.3.2 EXPLAIN QUERY PLAN实际示例](#432-explain-query-plan实际示例)
      - [4.3.3 预编译语句最佳实践（2025年最新）](#433-预编译语句最佳实践2025年最新)
    - [4.4 实际案例：Chrome浏览器中的SQLite使用](#44-实际案例chrome浏览器中的sqlite使用)
  - [五、性能优化点](#五性能优化点)
  ...
  - [七、Wikipedia对齐](#七wikipedia对齐)
    - [7.1 编译器概念对齐](#71-编译器概念对齐)
    - [7.2 虚拟机概念对齐](#72-虚拟机概念对齐)
    - [7.3 SQLite编译执行模型对齐](#73-sqlite编译执行模型对齐)
  - [🔗 相关资源](#-相关资源)
  - [📚 参考资料](#-参考资料)
  - [🔗 交叉引用](#-交叉引用)
    - [相关文档](#相关文档)
