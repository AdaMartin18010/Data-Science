...
- [事务与并发控制：MVCC与WAL机制深度论证](#事务与并发控制mvcc与wal机制深度论证)
  ...
  - [四、并发控制性能分析](#四并发控制性能分析)
    ...
    - [4.2 性能测试数据与代码示例](#42-性能测试数据与代码示例)
    - [4.3 最佳实践与代码示例](#43-最佳实践与代码示例)
      - [4.3.1 选择DELETE模式](#431-选择delete模式)
      - [4.3.2 选择WAL模式](#432-选择wal模式)
      - [4.3.3 实际案例：GitLab CI中的SQLite使用](#433-实际案例gitlab-ci中的sqlite使用)
...
#### 4.3.3 实际案例：GitLab CI中的SQLite使用
