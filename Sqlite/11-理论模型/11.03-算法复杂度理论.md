...
- [算法复杂度理论：SQLite操作的时间与空间复杂度](#算法复杂度理论sqlite操作的时间与空间复杂度)
  ...
  - [一、复杂度理论基础](#一复杂度理论基础)
    - [1.1 复杂度定义](#11-复杂度定义)
    - [1.2 复杂度表示法](#12-复杂度表示法)
    - [1.3 复杂度分析](#13-复杂度分析)
  - [二、查询操作复杂度](#二查询操作复杂度)
    - [2.1 选择查询复杂度](#21-选择查询复杂度)
    - [2.2 连接查询复杂度](#22-连接查询复杂度)
    - [2.3 聚合查询复杂度](#23-聚合查询复杂度)
    - [2.4 排序查询复杂度](#24-排序查询复杂度)
  - [三、B-Tree操作复杂度](#三b-tree操作复杂度)
    - [3.1 B-Tree查找复杂度](#31-b-tree查找复杂度)
    - [3.2 B-Tree插入复杂度](#32-b-tree插入复杂度)
    - [3.3 B-Tree删除复杂度](#33-b-tree删除复杂度)
    - [3.4 B-Tree范围查询复杂度](#34-b-tree范围查询复杂度)
  - [四、并发控制复杂度](#四并发控制复杂度)
    - [4.1 锁操作复杂度](#41-锁操作复杂度)
    - [4.2 事务管理复杂度](#42-事务管理复杂度)
    - [4.3 WAL操作复杂度](#43-wal操作复杂度)
  - [五、存储操作复杂度](#五存储操作复杂度)
    - [5.1 页面操作复杂度](#51-页面操作复杂度)
    - [5.2 缓存操作复杂度](#52-缓存操作复杂度)
    - [5.3 磁盘I/O复杂度](#53-磁盘io复杂度)
  - [六、复杂度理论总结](#六复杂度理论总结)
    - [6.1 复杂度总结表](#61-复杂度总结表)
    - [6.2 复杂度优化策略](#62-复杂度优化策略)
    - [6.3 实际性能考虑](#63-实际性能考虑)
    - [6.4 复杂度验证代码](#64-复杂度验证代码)
  - [🔗 相关资源](#-相关资源)
  - [📚 参考资料](#-参考资料)
