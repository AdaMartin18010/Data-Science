...
- [并发控制理论：事务隔离与锁机制](#并发控制理论事务隔离与锁机制)
  ...
  - [一、事务理论](#一事务理论)
    - [1.1 事务定义](#11-事务定义)
    - [1.2 事务属性理论](#12-事务属性理论)
    - [1.3 事务状态理论](#13-事务状态理论)
    - [1.4 事务调度理论](#14-事务调度理论)
  - [二、隔离性理论](#二隔离性理论)
    - [2.1 隔离级别定义](#21-隔离级别定义)
    - [2.2 隔离性异常理论](#22-隔离性异常理论)
    - [2.3 快照隔离理论](#23-快照隔离理论)
    - [2.4 隔离性保证理论](#24-隔离性保证理论)
  - [三、锁理论](#三锁理论)
    - [3.1 锁模型定义](#31-锁模型定义)
    - [3.2 锁兼容性理论](#32-锁兼容性理论)
    - [3.3 两阶段锁理论](#33-两阶段锁理论)
    - [3.4 死锁理论](#34-死锁理论)
  - [四、MVCC理论](#四mvcc理论)
    - [4.1 MVCC定义](#41-mvcc定义)
    - [4.2 版本管理理论](#42-版本管理理论)
    - [4.3 可见性理论](#43-可见性理论)
    - [4.4 WAL与MVCC](#44-wal与mvcc)
  - [五、并发控制理论总结](#五并发控制理论总结)
    - [5.1 理论模型要点](#51-理论模型要点)
    - [5.2 SQLite并发控制](#52-sqlite并发控制)
    - [5.3 理论应用](#53-理论应用)
    - [5.4 并发控制理论验证代码](#54-并发控制理论验证代码)
  - [🔗 相关资源](#-相关资源)
  - [📚 参考资料](#-参考资料)
