...
- [存储理论：页结构与B-Tree存储模型](#存储理论页结构与b-tree存储模型)
  ...
  - [📊 思维导图](#-思维导图)
  - [一、存储模型理论](#一存储模型理论)
    - [1.1 存储模型定义](#11-存储模型定义)
    - [1.2 页结构理论](#12-页结构理论)
    - [1.3 存储布局理论](#13-存储布局理论)
    - [1.4 存储效率理论](#14-存储效率理论)
  - [二、索引理论](#二索引理论)
    - [2.1 索引定义](#21-索引定义)
    - [2.2 B-Tree索引理论](#22-b-tree索引理论)
    - [2.3 索引选择理论](#23-索引选择理论)
    - [2.4 索引维护理论](#24-索引维护理论)
  - [三、缓存理论](#三缓存理论)
    - [3.1 缓存模型定义](#31-缓存模型定义)
    - [3.2 缓存替换理论](#32-缓存替换理论)
    - [3.3 缓存一致性理论](#33-缓存一致性理论)
    - [3.4 缓存性能理论](#34-缓存性能理论)
  - [四、持久化理论](#四持久化理论)
    - [4.1 持久化定义](#41-持久化定义)
    - [4.2 日志理论](#42-日志理论)
    - [4.3 恢复理论](#43-恢复理论)
  ...
  - [五、存储理论总结](#五存储理论总结)
    ...
    - [5.2 SQLite存储特性](#52-sqlite存储特性)
    - [5.3 理论应用](#53-理论应用)
    - [5.4 存储理论验证代码](#54-存储理论验证代码)
  - [🔗 相关资源](#-相关资源)
  - [📚 参考资料](#-参考资料)
