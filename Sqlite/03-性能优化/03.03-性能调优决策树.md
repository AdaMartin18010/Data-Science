...
- [性能调优决策树：系统化优化流程](#性能调优决策树系统化优化流程)
  ...
  - [4. 读性能优化决策树](#4-读性能优化决策树)
    - [4.1. 全表扫描问题](#41-全表扫描问题)
    - [4.2. 索引使用问题](#42-索引使用问题)
    - [4.3. 查询计划问题](#43-查询计划问题)
  - [5. 写性能优化决策树](#5-写性能优化决策树)
    - [5.1. 写入速度慢](#51-写入速度慢)
    - [5.2. 事务冲突](#52-事务冲突)
    - [5.3. 同步模式问题](#53-同步模式问题)
  - [6. 并发性能优化决策树](#6-并发性能优化决策树)
    - [6.1. 读并发问题](#61-读并发问题)
    - [6.2. 写并发问题](#62-写并发问题)
    - [6.3. 锁竞争问题](#63-锁竞争问题)
  - [7. 存储空间优化决策树](#7-存储空间优化决策树)
    - [7.1. 数据库文件过大](#71-数据库文件过大)
    - [7.2. 索引占用空间大](#72-索引占用空间大)
    - [7.3. WAL文件膨胀](#73-wal文件膨胀)
  - [8. 性能调优多维对比矩阵](#8-性能调优多维对比矩阵)
    - [8.1. 性能问题类型对比矩阵](#81-性能问题类型对比矩阵)
    - [8.2. 优化策略对比矩阵](#82-优化策略对比矩阵)
    - [8.3. 优化优先级矩阵](#83-优化优先级矩阵)
    - [8.4. 优化实施步骤](#84-优化实施步骤)
  - [9. 🔗 相关资源](#9--相关资源)
  - [10. 🔗 交叉引用](#10--交叉引用)
    - [10.1. 理论模型 🆕](#101-理论模型-)
    - [10.2. 设计模型 🆕](#102-设计模型-)
