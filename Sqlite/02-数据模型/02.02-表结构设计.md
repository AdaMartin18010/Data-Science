...
- [表结构设计：范式化与反范式化决策](#表结构设计范式化与反范式化决策)
  ...
  - [11. 🔗 交叉引用](#11--交叉引用)
    ...
    - [11.4. 核心架构文档 🆕](#114-核心架构文档-)
    - [11.5. 性能优化文档 🆕](#115-性能优化文档-)
    - [11.6. 知识图谱与导航 🆕](#116-知识图谱与导航-)
    - [11.7. 相关概念链接 🆕](#117-相关概念链接-)
      - [11.7.1. 表结构设计概念](#1171-表结构设计概念)
  - [12. 📚 参考资料](#12--参考资料)
...
推荐设计组合:
1. 读多写少 + 小数据量: 反范式化 + 冗余字段
2. 写多读少 + 大数据量: 范式化 + 3NF设计
3. 高性能要求: 反范式化 + 物化视图
4. 强一致性要求: 范式化 + 外键约束
```
...
- ⭐⭐ [优化策略](../03-性能优化/03.02-优化策略.md) - 索引优化策略（含论证脉络和决策树）
- ⭐⭐ [查询优化](../08-编程实践/08.03-查询优化.md) - 查询优化实践（含交叉引用）

### 11.6. 知识图谱与导航 🆕

- ⭐⭐⭐ [知识图谱与概念关系网络](../09-最新特性/09.03-SQLite知识图谱与概念关系网络.md) - 表结构设计概念关系（400+概念）
- ⭐⭐ [文档依赖关系图](../00-项目导航/06-文档依赖关系图.md) - 表结构设计文档依赖
- ⭐⭐ [术语标准化词典](../00-项目导航/03-术语词典/SQLite术语标准化词典.md) - 表结构设计术语索引

### 11.7. 相关概念链接 🆕

#### 11.7.1. 表结构设计概念

- **表结构设计** → [知识图谱：数据模型本体](../09-最新特性/09.03-SQLite知识图谱与概念关系网络.md#数据模型本体)
- **索引设计** → [知识图谱：B-Tree存储本体](../09-最新特性/09.03-SQLite知识图谱与概念关系网络.md#核心本体b-tree存储)
- **范式理论** → [数据模型理论](../11-理论模型/11.02-数据模型理论.md)
