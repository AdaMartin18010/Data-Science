...
- [数据类型系统：存储类与类型亲和性](#数据类型系统存储类与类型亲和性)
  ...
  - [七、类型系统多维对比矩阵](#七类型系统多维对比矩阵)
    - [7.1 存储类多维对比矩阵](#71-存储类多维对比矩阵)
    - [7.2 类型亲和性多维对比矩阵](#72-类型亲和性多维对比矩阵)
    - [7.3 严格表模式 vs 动态类型系统对比矩阵](#73-严格表模式-vs-动态类型系统对比矩阵)
    - [7.4 类型系统性能影响](#74-类型系统性能影响)
      - [7.4.1 存储空间](#741-存储空间)
    - [7.2 查询性能](#72-查询性能)
  - [🔗 相关资源](#-相关资源)
  - [📚 参考资料](#-参考资料)
...
- ⭐⭐ [SQLite 3.45+新特性](../09-最新特性/09.01-SQLite-3.45+新特性.md) - 严格表模式增强
