...
- [Wikipedia概念对齐：定义、属性、内涵、外延](#wikipedia概念对齐定义属性内涵外延)
  ...
  - [📑 目录](#-目录)
  - [📊 思维导图](#-思维导图)
  - [一、核心定义（Wikipedia对齐）](#一核心定义wikipedia对齐)
    - [1.1 嵌入式数据库引擎](#11-嵌入式数据库引擎)
    - [1.2 零配置（Zero-Configuration）](#12-零配置zero-configuration)
    - [1.3 事务型SQL数据库](#13-事务型sql数据库)
  - [二、属性特征（Wikipedia属性对齐）](#二属性特征wikipedia属性对齐)
    - [2.1 MVCC变体机制说明](#21-mvcc变体机制说明)
    - [2.2 B-Tree存储结构](#22-b-tree存储结构)
  - [三、关系扩展（Wikipedia关系对齐）](#三关系扩展wikipedia关系对齐)
    - [3.1 与关系型数据库的关系](#31-与关系型数据库的关系)
    - [3.2 在数据库生态系统中的位置](#32-在数据库生态系统中的位置)
    - [3.3 与其他数据库的对比](#33-与其他数据库的对比)
  - [四、Wikipedia概念对齐多维对比矩阵](#四wikipedia概念对齐多维对比矩阵)
    - [4.1 概念定义对比矩阵](#41-概念定义对比矩阵)
    - [4.2 属性特征对比矩阵](#42-属性特征对比矩阵)
    - [4.3 应用场景对比矩阵](#43-应用场景对比矩阵)
  - [五、Wikipedia核心概念总结](#五wikipedia核心概念总结)
    - [5.1 内涵（本质特征）](#51-内涵本质特征)
    - [5.2 外延（应用范围）](#52-外延应用范围)
    - [5.3 属性（技术特征）](#53-属性技术特征)
  - [🔗 相关资源](#-相关资源)
  - [📚 参考资料](#-参考资料)
